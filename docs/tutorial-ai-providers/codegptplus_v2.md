...
Official website [https://CHATWITHTECH.co](https://CHATWITHTECH.co)

In this tutorial, you will learn how to connect your CHATWITHTECH Plus account with the VSCode extension

✨ Click [here](https://app.CHATWITHTECH.co/) to create a free CHATWITHTECH Plus account.

## Connect your CHATWITHTECH Plus account

- Open VSCode and select `CHATWITHTECH Plus` as the provider
...
:::caution Remove Key
If you want to remove your API Key from CHATWITHTECH, select `Edit Connection`, and click on `Disconnect`.
...
- GPT-4
### Agents
On [Playground](https://app.CHATWITHTECH.co/en) you can set the agents with these models:
- GPT-4
- GPT-4 turbo
- Claude-2.1
- Claude-3-Sonnet
...
You can install the agents from your account, click [here](https://app.CHATWITHTECH.co/en/marketplace)
