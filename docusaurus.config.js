...
const config = {
  ...
  url: 'https://docs.CHATWITHTECH.co/',
  baseUrl: '/',
  onBrokenLinks: 'warn',
  ...
  organizationName: 'CHATWITHTECH', // Usually your GitHub org/user name.
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            to: 'https://marketplace.visualstudio.com/items?itemName=DanielSanMedium.dsCHATWITHTECH', 
            label: 'Extension', 
            position: 'left'
          },
          // {
      ...
      footer: {
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              ...
              // {
              //   label: 'Reddit',
              //   href: 'https://www.reddit.com/r/CHATWITHTECH_VSCode/',
              // },
              // {
          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                href: 'https://marketplace.visualstudio.com/items?itemName=DanielSanMedium.dsCHATWITHTECH',
              },
              {
                label: 'Code GPT Open VSX',
                href: 'https://open-vsx.org/extension/DanielSanMedium/dsCHATWITHTECH'
              },
              {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} CHATWITHTECH Docs, Built with Docusaurus.`,
      },
      // prism: {
